...
var kanaF = {
    ...
    baseClass: ["Nohr Princess"],
    firstParent: corrinM,
    secondParent: ["-", "Felicia", "Azura", "Mozu", "Elise", "Effie", "Nyx", "Camilla", "Selena", "Beruka", "Peri", "Charlotte", "Flora", "Rinkah", "Sakura", "Hana", "Hinoka", "Orochi", "Setsuna", "Oboro", "Kagero", "Reina", "Scarlet", "Sophie", "Midori", "Selkie", "Mitama", "Caeldori", "Rhajat"],
    baseHPGR: 30,
    baseStrGR: 35,
    baseMagGR: 30,
    baseSklGR: 40,
...
var kanaM = {
    ...
    baseClass: ["Nohr Prince"],
    firstParent: corrinF,
    secondParent: ["-", "Gunter", "Jakob", "Kaze", "Silas", "Shura", "Izana", "Arthur", "Odin", "Niles", "Laslow", "Benny", "Leo", "Keaton", "Xander", "Siegbert", "Forrest", "Ignatius", "Percy", "Subaki", "Saizo", "Azama", "Hayato", "Hinata", "Takumi", "Kaden", "Ryoma", "Yukimura", "Dwyer", "Shigure", "Shiro", "Kiragi", "Asugi", "Hisame"],
    baseHPGR: 30,
    baseStrGR: 35,
    baseMagGR: 30,
    baseSklGR: 40,
